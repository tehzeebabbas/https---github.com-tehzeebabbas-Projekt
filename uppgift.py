...
class Konto:
    ...
    def sätt_in(self, belopp):
        ...
        self.transaktioner.append(
            Transaktion("Insättning", belopp)
        )

        print(f"Du satte in {belopp} kr")
    ...
    def överför(self, belopp, annat_konto):
        ...
        self.transaktioner.append(Transaktion("Överföring ut", belopp,annat_konto.kontonummer))

        # Sparar transaktion på konto 2
        annat_konto.transaktioner.append(Transaktion("Överföring in",belopp,self.kontonummer))

        print(f"Du överförde {belopp} kr")
        print(f"Till konto {annat_konto.kontonummer}")
...
class Kreditkonto(Konto):
    ...
    def ta_ut(self, belopp):
        ...
        self.transaktioner.append(
            Transaktion("Kredituttag", belopp)
        )
...
class Bank:
    ...
    def visa_riksbank_data(self):
        ...
        url = "https://api.riksbank.se/swea/v1/CalendarDays/2024-01-01"
...
def meny():
    ...
    while True:
        ...
        print("4. Visa saldo")
        print("5. Visa transaktioner")
        print("6. Lägg till ränta")
        print("7. Visa kontoinfo")
        print("8. Visa Riksbank API-data")
        print("9. Spara konton som JSON")
        print("10. Byt bank")
        print("11. Avsluta")
